  ...
  const handleVoiceResult = (transcript: string) => {
    ...
    if (detectedCategory === selectedCategory) {
      ...
      // Toiletries keywords
        ...
        lowerText.includes("deodorant") ||
        lowerText.includes("razor") ||
        lowerText.includes("brush")
      ) {
        const toiletriesCategory = categories.find(
          (cat) =>
            cat.name.toLowerCase().includes("toiletri") ||
